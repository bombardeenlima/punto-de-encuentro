...
<div class="relative mt-8 h-[500px] w-full rounded-xl border border-border bg-card p-6 shadow-sm">
	<div class="mb-4 flex flex-col items-center">
		<h3 class="text-xl font-bold">Análisis de Similitud</h3>
		<p class="mt-1 max-w-xl text-center text-xs text-muted-foreground">
			Haz clic en los nombres del partido abajo para ocultar/mostrar su perfil. Por defecto se
			muestran tus 3 candidatos más afines.
		</p>
	</div>
